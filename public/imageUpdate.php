...
function ciniki_gallery_imageUpdate(&$ciniki) {
    ...
    $rc = ciniki_gallery_checkAccess($ciniki, $args['tnid'], 'ciniki.gallery.imageUpdate', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
    ...
    return ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.gallery.image', $args['gallery_image_id'], $args, 0x07);
}
?>
